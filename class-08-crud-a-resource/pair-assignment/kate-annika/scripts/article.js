(function(module) {
  ...
  Article.createTable = function(callback) {
    webDB.execute(
      'CREATE TABLE IF NOT EXISTS articles (title VARCHAR(50), category VARCHAR(50), author VARCHAR(50), authorUrl VARCHAR(50), publishedOn date, body VARCHAR(50));',
      function(result) {
  ...
  Article.prototype.updateRecord = function(callback) {
    webDB.execute(
      [
        {
          'sql': 'UPDATE articles SET title=?, category=?, author=?, authorUrl=?, publishedOn=?, body=? WHERE title=?',
